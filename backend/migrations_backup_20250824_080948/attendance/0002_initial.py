...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="attendancesession",
            index=models.Index(
                fields=["class_part", "session_date"],
                name="attendance__class_p_ecc953_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="attendancesession",
            index=models.Index(
                fields=["teacher", "session_date"],
        ...
        migrations.AddIndex(
            model_name="attendancesession",
            index=models.Index(
                fields=["substitute_teacher", "session_date"],
                name="attendance__substit_d03e21_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="attendancesession",
            index=models.Index(
                ...
                name="attendance__session_375493_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="attendancesession",
            index=models.Index(
                fields=["attendance_code", "is_active"],
                name="attendance__attenda_b9660e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="attendancesession",
            index=models.Index(
                fields=["is_substitute_session", "session_date"],
                name="attendance__is_subs_53ac4e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="attendancerecord",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="attendance__student_b686d4_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="attendancerecord",
            index=models.Index(
                fields=["status", "attendance_session"],
                name="attendance__status_7f4af9_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="attendancerecord",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="attendance__student_5b49d6_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="permissionrequest",
            index=models.Index(
                fields=["class_part", "session_date"],
                name="attendance__class_p_7f904b_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="permissionrequest",
            index=models.Index(
                fields=["request_status", "session_date"],
                name="attendance__request_f33c70_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="permissionrequest",
            index=models.Index(
                fields=["program_type", "request_status"],
                name="attendance__program_938ba4_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddIndex(
            model_name="rostersync",
            index=models.Index(
                fields=["class_part", "sync_date"],
                name="attendance__class_p_c0e286_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="rostersync",
        ...
        migrations.AddIndex(
            model_name="rostersync",
            index=models.Index(
                fields=["is_successful", "sync_timestamp"],
                name="attendance__is_succ_7c0ac2_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
            name="rostersync",
