# Generated migration for ProgramTransition model
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="program_transitions",
                        to="curriculum.major",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["journey", "sequence_number"], name="enrollment__journey_9e8a14_idx"),
        ),
        migrations.AddIndex(
            model_name="programtransition",
            index=models.Index(fields=["transition_date", "to_program_type"], name="enrollment__transit_4c6f8f_idx"),
        ),
        migrations.AddIndex(
            model_name="programtransition",
            index=models.Index(fields=["completion_status", "to_program_type"], name="enrollment__complet_d5c2e9_idx"),
        ),
