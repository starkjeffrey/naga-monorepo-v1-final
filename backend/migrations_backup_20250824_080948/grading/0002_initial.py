    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(
                help_text="Class component this grade is for",
        ...
        migrations.AddField(
            ...
            name="enrollment",
            field=models.ForeignKey(
                help_text="Student enrollment this grade belongs to",
                on_delete=django.db.models.deletion.CASCADE,
                related_name="class_part_grades",
        ...
        migrations.AddField(
            ...
            name="major",
            field=models.ForeignKey(
                help_text="Major this GPA calculation is based on",
                on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            ...
            name="term",
            field=models.ForeignKey(
                help_text="Term this GPA calculation is for",
                on_delete=django.db.models.deletion.CASCADE,
                related_name="gpa_records",
                to="curriculum.term",
                verbose_name="Term",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["scale_type", "is_active"],
                name="grading_gra_scale_t_8260fd_idx",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name="classpartgrade",
            index=models.Index(
                fields=["enrollment", "grade_status"],
                name="grading_cla_enrollm_e3e50f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="classpartgrade",
            index=models.Index(
                fields=["class_part", "grade_status"],
                name="grading_cla_class_p_1f9927_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="classpartgrade",
        ...
        migrations.AddIndex(
            model_name="classsessiongrade",
            index=models.Index(
                fields=["enrollment", "calculated_at"],
                name="grading_cla_enrollm_2008d4_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="classsessiongrade",
        ...
        migrations.AddIndex(
            model_name="gparecord",
            index=models.Index(
                fields=["gpa_type", "-calculated_at"],
                name="grading_gpa_gpa_typ_7f207d_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
            name="gparecord",
        ...
        migrations.AddIndex(
            model_name="gradechangehistory",
            index=models.Index(
                fields=["class_part_grade", "-changed_at"],
                name="grading_gra_class_p_41271a_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="gradechangehistory",
            index=models.Index(
                ...
                name="grading_gra_changed_756863_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="gradechangehistory",
            index=models.Index(
                ...
                name="grading_gra_change__eb2392_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="gradeconversion",
            index=models.Index(
                fields=["grading_scale", "display_order"],
                name="grading_gra_grading_391d0f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="gradeconversion",
